...
class ETOPONav extends StatefulWidget {
  const ETOPONav({super.key});

  @override
  State<ETOPONav> createState() => ETOPONavState();
}

class ETOPONavState extends State<ETOPONav> {
  String searchQuery = '';
              ...
              child: ListView(
                children: [
                    _buildClickableImageCard(
                      context: context,
                      title: 'Conveyor Lubrication Systems (4)',
                      imagePath:
                          'assets/industrial/Enclosed Track Overhead Power Only and P&F (10)/Conveyor Lub. Systems (4)/title.png',
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                    ...
                    _buildClickableImageCard(
                      context: context,
                      title: 'Conveyor Monitor Systems (2)',
                      imagePath:
                          'assets/industrial/Enclosed Track Overhead Power Only and P&F (10)/Conveyor Monitor Systems (2)/Title.png',
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
