...
class ETIPONav extends StatefulWidget {
  const ETIPONav({super.key});

  @override
  State<ETIPONav> createState() => ETIPONavState();
}

class ETIPONavState extends State<ETIPONav> {
  String searchQuery = '';
              ...
              child: ListView(
                children: [
                    _buildClickableImageCard(
                      context: context,
                      title: 'Conveyor Cleaning Solutions (2)',
                      imagePath:
                          'assets/industrial/Enclosed Track Inverted Power Only and P&F (8)/Conveyor Cleaning Solutions (2)/Title.png',
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                    ...
                    _buildClickableImageCard(
                      context: context,
                      title: 'Conveyor Monitor Systems (1)',
                      imagePath:
                          'assets/industrial/Enclosed Track Inverted Power Only and P&F (8)/Conveyor Monitor Systems (1)/title.png',
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
