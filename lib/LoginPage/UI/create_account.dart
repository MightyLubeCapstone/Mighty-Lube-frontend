              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    buildTextField('Company Name:*', 'Company Name', companyController,
                    ...
                    const SizedBox(height: 15),
                    buildTextField('Phone Number:', 'Phone Number', phoneController,
                        borderColor: Colors.grey),
                    const SizedBox(height: 15),
                    buildTextField('Email Address:*', 'Email Address', emailController,
                    ...
                    buildTextField('Password:*', 'Password', passwordController,
                        obscureText: true, borderColor: Colors.grey, onChanged: (value) {
                      _validatePassword(value);
                      passNotifier.value = PasswordStrength.calculate(text: value);
                    }, errorText: _errorPassword != null ? '' : null),
                    const SizedBox(height: 15),
                    buildTextField(
                        'Confirm Password:* ', 'Confirm Password', confirmPasswordController,
                        obscureText: true, borderColor: Colors.grey, onChanged: (value) {
                    ...
                    buildGradientButton('Register', () {
                      createAccount(context); // Call createAccount method on button press
                    }),
                    const SizedBox(height: 10),
