...
// import 'package:mighty_lube/Utils/utils.dart';
...
//       "conveyorStrand",
//     ],
//     "custom": ["operatingVoltage", "controlVoltage"],
//     "monitoring": ["existingMonitoring", "addMonitoring"],
...
//       setState(() {});
//     });
//     controlVoltage.addListener(() {
//       validate.onNameOpChanged(controlVoltage.text, 'controlVoltage');
//       setState(() {});
//     });
...
//     validate.validateTextField(controlVoltage.text, 'controlVoltage');
...
//     validate.validateDropdownField(addMonitoring, 'addMonitoring');
...
//     validate.validateDropdownField(plantLayout, 'plantLayout');
//     validate.validateDropdownField(chainPicture, 'chainPicture');
...
//         ),
//
//         /// Added to match the new field currently available on the website.
//         /// Pending confirmation on whether this field should also be included
//         /// in the mobile app.
//         Utils.addNewFiledByWebsite ?  CommonWidgets.buildDropdownFieldError(
...
//               (value) {
//             setState(() {
//               chainPicture = value; // Update state properly
//               validate.validateDropdownField(chainPicture, 'chainPicture');
//             });
//           },
//           errorText: errors['directionOfTravel'],
...
//                 crossAxisAlignment: CrossAxisAlignment.start,
//                 children: [
//                   CommonWidgets.buildTextField('Operating Voltage - Single Phase: (Volts/hz] *', operatingVoltage, errorText: errors['operatingVoltage']),
//                   if (errors['operatingVoltage'] != null) buildErrorText(errors['operatingVoltage']!),
//                 ],
//               );
//             }),
//         ValueListenableBuilder<TextEditingValue>(
//             valueListenable: controlVoltage,
//             builder: (context, value, child) {
//               validate.validatorDelay(value.text, 'controlVoltage');
//               return Column(
//                 crossAxisAlignment: CrossAxisAlignment.start,
//                 children: [
//                   CommonWidgets.buildTextField('Control Voltage (Volts/hz) *', controlVoltage, errorText: errors['controlVoltage']),
//                   if (errors['controlVoltage'] != null) buildErrorText(errors['controlVoltage']!),
//                 ],
//               );
//             }),
//         CommonWidgets.buildSectionDivider(),
...
//             });
//           },
//           errorText: errors['addMonitoring'],
//         ),
//         CommonWidgets.buildSectionDivider(),
//         if (existingMonitoring == 1)
//           CommonWidgets.buildTemplateA(templateAKey, validate, data: templateAData, callback: (data) {
//             templateAData = data;
//           }),
//       ],
//     );
...
//         'controlVoltage': controlVoltage.text,
