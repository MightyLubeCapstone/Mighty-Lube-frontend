    ...
    return Column(
      ...
      children: [
        ...
        const Padding(
          ...
          child: Text(
            'Overhead Non-Powered Mighty Lube Chain Cleaners 8074-B, 8075-B',
            style: TextStyle(
              fontSize: 24,
          ...
          child: Card(
            ...
            child: Container(
              ...
              child: ClipRRect(
                borderRadius: BorderRadius.circular(15),
                child: Image.asset(
                  'assets/industrial/Enclosed Track Inverted Power Only and P&F (8)/Conveyor Cleaning Solutions (2)/8074-B.png', // Path to your image
                  fit: BoxFit.cover,
                ),
              ),
            ),
