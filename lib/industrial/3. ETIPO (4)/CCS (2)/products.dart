...
import 'package:mighty_lube/industrial/3.%20ETIPO%20(4)/CCS%20(2)/O8074/UI/O8074.dart';

import 'package:mighty_lube/industrial/3.%20ETIPO%20(4)/CCS%20(2)/OUN91/UI/OUN91.dart';
                ...
                children: [
                  _buildClickableImageCard(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const OUN91Page()),
                      );
                    },
                  ),
                  _buildClickableImageCard(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const O8074Page()),
                      );
                    },
                  ),
                ],
