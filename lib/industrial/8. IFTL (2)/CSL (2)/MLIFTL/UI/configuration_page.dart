...
class _ConfigurationSectionState extends State<ConfigurationSection> {
  ...
  void initState() {
    ...
    conveyorLength.addListener(() {
      validate.onNum247Changed(conveyorLength.text, 'conveyorLength');
      setState(() {});
    });
  }
...
//actual buttons w/ the questions :) 
  ...
  if (validForm()) {
    ...
    status = FormAPI().addOrder("mliftl", iftlData, numRequested);
      return null;
    } else {
      ...
      children: [
        ...
        GestureDetector(
          onTap: () {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => const IFTLProducts()),
