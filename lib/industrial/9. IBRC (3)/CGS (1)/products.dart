...
class IBRCProducts extends StatefulWidget {
  const IBRCProducts({super.key});

  @override
  State<IBRCProducts> createState() => IBRCProductsState();
}

class IBRCProductsState extends State<IBRCProducts> {
  String searchQuery = '';
                    ...
                    _buildClickableImageCard(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const OPCO300Page()),
                        );
                      },
                    ),
                ],
