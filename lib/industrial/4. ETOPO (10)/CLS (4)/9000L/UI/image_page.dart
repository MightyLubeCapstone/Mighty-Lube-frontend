    ...
    return Column(
      ...
      children: [
        ...
        const Padding(
          ...
          child: Text(
            '9000L Series Enclosed Track Conveyor Lubricators',
            style: TextStyle(
              fontSize: 24,
          ...
          child: Card(
            ...
            child: Container(
              ...
              child: ClipRRect(
                borderRadius: BorderRadius.circular(15),
                child: Image.asset(
                  'assets/industrial/Enclosed Track Overhead Power Only and P&F (10)/Conveyor Lub. Systems (4)/9000L.png', // Path to your image
                  fit: BoxFit.cover,
                ),
              ),
            ),
