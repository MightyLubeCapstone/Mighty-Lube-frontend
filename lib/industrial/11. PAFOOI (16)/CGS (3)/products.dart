...
import 'package:mighty_lube/industrial/11.%20PAFOOI%20(16)/CGS%20(3)/FR317/UI/CR317.dart';
import 'package:mighty_lube/industrial/11.%20PAFOOI%20(16)/CGS%20(3)/FR314/UI/FR314.dart';
import 'package:mighty_lube/industrial/11.%20PAFOOI%20(16)/CGS%20(3)/GPC/UI/GPC.dart';
...
class CGSProducts extends StatefulWidget {
  const CGSProducts({super.key});

  @override
  State<CGSProducts> createState() => CGSProductsState();
}

class CGSProductsState extends State<CGSProducts> {
  String searchQuery = '';
              ...
              child: ListView(
                children: [
                  _buildClickableImageCard(
                    ...
                    imagePath: 'assets/industrial/PFOOI/CGS/FR317.png',
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const CR317Page()),
                      );
                    },
                  ),
                  _buildClickableImageCard(
                    ...
                    imagePath: 'assets/industrial/PFOOI/CGS/FR314.png',
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const FR314Page()),
                      );
                    },
                  ),
                  _buildClickableImageCard(
                    ...
                    imagePath: 'assets/industrial/PFOOI/CGS/GPC.png',
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const GCPPage()),
                      );
                    },
                  ),
                ],
