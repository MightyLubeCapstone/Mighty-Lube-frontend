...
import 'package:mighty_lube/industrial/11.%20PAFOOI%20(16)/CCS%20(3)/products.dart';
import 'package:mighty_lube/industrial/11.%20PAFOOI%20(16)/CGS%20(3)/products.dart';
import 'package:mighty_lube/industrial/11.%20PAFOOI%20(16)/CLS%20(7)/products.dart';
import 'package:mighty_lube/industrial/11.%20PAFOOI%20(16)/CMS%20(3)/products.dart';
...
class PAFOOINav extends StatefulWidget {
  const PAFOOINav({super.key});

  @override
  State<PAFOOINav> createState() => PAFOOINavState();
}

class PAFOOINavState extends State<PAFOOINav> {
  String searchQuery = '';
              ...
              child: ListView(
                children: [
                  _buildClickableImageCard(
                    ...
                    imagePath: 'assets/industrial/PFOOI/CCS/CCS.png',
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                  ...
                  _buildClickableImageCard(
                    ...
                    imagePath: 'assets/industrial/PFOOI/CGS/CGS.png',
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                  ...
                  _buildClickableImageCard(
                    ...
                    imagePath: 'assets/industrial/PFOOI/CLS/CLS.png',
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                  ...
                  _buildClickableImageCard(
                    ...
                    imagePath: 'assets/industrial/PFOOI/CMS/CMS.png',
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
