  ...
  Widget buildConveyorSpecifications() {
    return Column(
      ...
      children: [
        ...
        CommonWidgets.buildDropdownField(
            'Optional 5 Gallon Reservoir', ['Yes', 'No']),
        CommonWidgets.buildDropdownField(
  ...
  Widget buildController() {
    return Column(
      ...
      children: [
        ...
        CommonWidgets.buildDropdownField("Controls other units", ["Yes", "No"]),
        CommonWidgets.buildDropdownField(
        ...
        CommonWidgets.buildTextField("Pre-Mounting Requirements:", preMount),
