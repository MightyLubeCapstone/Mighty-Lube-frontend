...
import 'package:mighty_lube/industrial/10.%20OHPRLB%20(20)/CLS%20(7)/9000L/UI/9000L.dart';
import 'package:mighty_lube/industrial/10.%20OHPRLB%20(20)/CLS%20(7)/CDL/UI/CDL.dart';
import 'package:mighty_lube/industrial/10.%20OHPRLB%20(20)/CLS%20(7)/ES/UI/ES.dart';
import 'package:mighty_lube/industrial/10.%20OHPRLB%20(20)/CLS%20(7)/OP139A/UI/OP139A.dart';
import 'package:mighty_lube/industrial/10.%20OHPRLB%20(20)/CLS%20(7)/OP4A/UI/OP4A.dart';
import 'package:mighty_lube/industrial/10.%20OHPRLB%20(20)/CLS%20(7)/OP52/UI/OP52.dart';
                ...
                children: [
                  _buildClickableImageCard(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const Page2100LBeam()),
                      );
                    },
                  ),
                  _buildClickableImageCard(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const Page9000LBeam()),
                      );
                    },
                  ),
                  _buildClickableImageCard(
                    ...
                    imagePath: 'assets/industrial/OHPRLB(20)/CLS/CDL.png',
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const CDLPage()),
                      );
                    },
                  ),
                  _buildClickableImageCard(
                    context: context,
                    title: 'E-Series',
                    imagePath: 'assets/industrial/OHPRLB(20)/CLS/ES.png',
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const ESPage()),
                      );
                    },
                  ),
                  _buildClickableImageCard(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const OP4APage()),
                      );
                    },
                  ),
                  _buildClickableImageCard(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const OP52Page()),
                      );
                    },
                  ),
                  _buildClickableImageCard(
                    context: context,
                    title: 'OP-139A',
                    imagePath: 'assets/industrial/OHPRLB(20)/CLS/OP139A.png',
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const OP139APage()),
                      );
                    },
                  ),
                ],
