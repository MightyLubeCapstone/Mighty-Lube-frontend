...
import 'package:mighty_lube/industrial/11.%20PAFOOI%20(17)/CCS%20(3)/300I/UI/300I.dart';
import 'package:mighty_lube/industrial/11.%20PAFOOI%20(17)/CCS%20(3)/OP8/UI/OP8.dart';
import 'package:mighty_lube/industrial/11.%20PAFOOI%20(17)/CCS%20(3)/OP8NP/UI/OP8NP.dart';
              ...
              child: ListView(
                children: [
                  _buildClickableImageCard(
                    ...
                    imagePath: 'assets/industrial/PFOOI/CCS/300I.png',
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const Page300I()),
                      );
                    },
                  ),
                  _buildClickableImageCard(
                    ...
                    imagePath: 'assets/industrial/PFOOI/CCS/OP8.png',
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const OP8Page()),
                      );
                    },
                  ),
                  _buildClickableImageCard(
                    ...
                    imagePath: 'assets/industrial/PFOOI/CCS/OP8NP.png',
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const OP8NPPage()),
                      );
                    },
                  ),
                ],
