...
class _ConfigurationSectionState extends State<ConfigurationSection> {
  ...
  Widget buildCustomerPowerUtilitiesContent() {
    return Column(
      ...
      children: [
        ...
        CommonWidgets.buildDropdownField('Compressed Air Supply Unit', ['PSI', 'KPI', 'Bar']),
        CommonWidgets.buildSectionDivider(),
      ],
    );
  }
  ...
  Future<VoidCallback?> addOP139AConfiguration(int numRequested) async {
    if (validForm()) {
      ...
      status = await FormAPI().addOrder("FRO_OP139A", configurationData, numRequested);
      if (!mounted) {
        return Future(
          () {
            return null;
