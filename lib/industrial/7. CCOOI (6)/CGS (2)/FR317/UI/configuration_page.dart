...
class _ConfigurationSectionState extends State<ConfigurationSection> {
    ...
    return Column(
      ...
      children: [
        ...
        CommonWidgets.buildMeasurementFieldWithImage(
          context: context,
          title:
              "Inverted Power and Free Trolley Pitch [Spacing] Minimum - For Variables pitch chain, Provide the Minimum Pitch Dimensions (S)",
  ...
  Future<VoidCallback?> addFR317Configuration(int numRequested) async {
    if (validForm()) {
      dynamic fr317Data = {
      ...
      status = await FormAPI().addOrder("FRO_317", fr317Data, numRequested);
      if (!mounted) {
        return Future(
          () {
            return null;
