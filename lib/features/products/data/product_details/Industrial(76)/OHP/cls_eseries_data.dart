...
const ProductDetailData overheadESeriesData = ProductDetailData(
  id: 'OHP_ES',
  title: 'E-Series',
  imagePath: AppAssets.OHP_CLS_ES,
  description: 'The ChainMaster E-Series Automatic Conveyor Lubrication System is an all-electric oiler designed to deliver metered amounts of lubricant in solid shot form to conveyor wear points. The lubricant shots are discharged from nozzles which are rigidly mounted close to the moving wear points.',
