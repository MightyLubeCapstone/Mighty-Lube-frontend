...
const ProductDetailData pfo_9000l_IBeamData =
ProductDetailData(
  // =========================================================
  // PRODUCT INFORMATION
  // =========================================================

  id: 'PFO_CLS_9000LIBEAM',
  title: '9000L Series Central Overhead I-Beam Conveyor Lubricators',
  imagePath: AppAssets.PFO_CLS_9000L,
  description: '9000L Series Central Overhead I-Beam Conveyor Lubricators configuration.',
  ...
  configurationSections: [
    ...
    // =======================================================
    // 8. TECHNICIAN NOTE
    // Retained from existing application workflow.
    // =======================================================
