...
ProductDetailData(
  ...
  description:
  'Multi Line (Permanent) ALL IN ONE Monitoring + Lubrication configuration.',
  configurationSections: [
    ...
    ProductConfigurationSection(
      ...
      fields: [
        ...
        ProductFieldData(
          key: 'specialOptionsPleaseSpecify',
    ...
    ProductConfigurationSection(
      id: 'commentsAdditionalInformation',
      title: 'Comments / Additional Information',
      fields: [
        ProductFieldData(
